...
namespace _2nd.Semester.Eksamen.WebUi.Components.Pages
{
    public partial class Home
    {
        ...
        public async void InjectData()
        {
            ...
            var employee1 = new Employee("Alice", "Johnson", "alice.johnson@example.com", "55511141", address1, 1.2m, "5 years", "Technician", "POOPING, SHITTING, PISSING, CUMMING", "Female", new TimeSpan(8, 0, 0), new TimeSpan(16, 0, 0));
            var employee2 = new Employee("Bob", "Smith", "bob.smith@example.com", "45552222", address2, 1.5m, "10 years", "Electrician", "POOPING, SHITTING, PISSING, CUMMING, joking, gooning, pulling my finger and farting", "Male", new TimeSpan(9, 0,0), new TimeSpan(17,0,0));
