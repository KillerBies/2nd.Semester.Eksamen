...
namespace Components.Pages
{
    public partial class Home
    {
        ...
        {
            var customer1 = new PrivateCustomer("poop",Gender.Male, new DateOnly(2004, 2, 1), "shit", new Address("oiio", "323212", "fda", "43f"), "12345678", "21w@dwq.com", "", false);
            var customer2 = new PrivateCustomer("pwop",Gender.Male, new DateOnly(2004, 2, 1), "sfgds", new Address("oiio", "323217", "fda", "43f"), "12345578", "21w@dwq.com","",false);
